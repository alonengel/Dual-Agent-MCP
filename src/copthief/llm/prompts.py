...
_SHARED = (
    ...
    "relay; there is no rigid wire protocol. In every message you MUST state your "
    "current cell explicitly as (x,y). Keep each message to one or two sentences."
)
...
_COP = (
    ...
    "state your move and your new (x,y) position."
)
