...
| `strategy/` | Move strategies: lookahead (default, depth-1 minimax), minimax (depth-N search — solves the 5×5 game), linear-FA (RL, strongest *learned* cop), belief, adaptive, heuristic, tabular Q |
